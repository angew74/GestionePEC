...
namespace SendMail.Data.OracleDb
{
    public class ContattoOracleDb : Com.Delta.Data.Oracle10.OracleDao<OracleSessionManager, ISessionModel>, IContattoDao
    {
        ...
        private const String insertStatement = " INSERT INTO RUBR_CONTATTI (MAIL,FAX,TELEFONO,REF_ID_REFERRAL,FLG_PEC,SOURCE,NOTE,CONTACT_REF) VALUES (:pMAIL,:pFAX,:pTELEFONO,:pREFIDREFERRAL,:pFLGPEC,:pSOURCE,:pNOTE,:pCONTACT_REF) RETURNING ID_CONTACT INTO :pIDCONTACT";
