...
namespace ActiveUp.Net.Mail
{
    ...
    public class Header
    {
        ...
        string uid=null;
        int localIndex = -1;
        string folderTipo = null;
        decimal folderId = -1;
        string parentFolder = null;

        /// <summary>
        /// Gets or sets the index of the local.
        /// </summary>
        /// <value>
        ...
        public decimal FolderId
        {
            get { return folderId; }
            set { folderId = value; }
        }

        public string FolderTipo
        {
            get { return folderTipo; }
            set { folderTipo = value; }
        }
