    ...
    public class SmtpClient : System.Net.Sockets.TcpClient
	{
        ...
        #region Delegates and associated private fields
            ...
            private void DoSslHandShake(ActiveUp.Net.Security.SslHandShake sslHandShake)
            {
                ...
                System.IO.StreamReader clearTextReader = new System.IO.StreamReader(base.GetStream());
                System.IO.StreamWriter clearTextWriter = new System.IO.StreamWriter(base.GetStream());
                ...
                clearTextWriter.WriteLine("HELO smtp.telecompost.it");
                string helloResponse = clearTextReader.ReadLine();
            ...
            #region Public methods
                ...
                #region Connecting, authenticating and disconnecting
                    ...
                    {
                        return this.ConnectSsl(host, 25/* ALBERTO:TEST 465*/, new ActiveUp.Net.Security.SslHandShake(host));
                    }

                    public IAsyncResult BeginConnectSsl(string host, AsyncCallback callback)
                    {
                        return this.BeginConnectSsl(host, 25/* ALBERTO:TEST 465*/, new ActiveUp.Net.Security.SslHandShake(host), callback);
                    }
                    public string ConnectSsl(string host, ActiveUp.Net.Security.SslHandShake sslHandShake)
                    {
                        return this.ConnectSsl(host, 25/* ALBERTO:TEST 465*/, sslHandShake);
                    }
                    public IAsyncResult BeginConnectSsl(string host, ActiveUp.Net.Security.SslHandShake sslHandShake, AsyncCallback callback)
                    {
                        return this.BeginConnectSsl(host, 25/* ALBERTO:TEST 465*/, sslHandShake, callback);
                    }
                    ...
                    public string ConnectSsl(string host, int port, ActiveUp.Net.Security.SslHandShake sslHandShake)
                    {
                        ...
                        //string response = this.ReadLine();
                        this.OnConnected(new ActiveUp.Net.Mail.ConnectedEventArgs("OK"));
                        return "OK";
                    }
                ...
                #region Sending methods
		            ...
		            public static bool Send(Message message, string host, string username, string password, SaslMechanism mechanism)
		            {
                        ...
                        // modifica per sistema autenticazione server smtp mail.comune.roma.it
