        ...
        public static System.Text.Encoding GetEncoding(string encodingName)
        {
            ...
            catch
            {
                try
                {
                    ...
                    // Attenzione!!
                    // aggiunto da Luigi per encoding di windows
                    else if (encodingName.StartsWith("cp", StringComparison.InvariantCultureIgnoreCase))
                        encodingName = encodingName.ToLower().Replace("cp", "windows-");
