...
namespace ActiveUp.Net.Mail
{
    ...
    public class Message : Header
    {
        ...
        /// 
        /// Message message = pop.RetrieveMessageObject(1,false); //Retrieve message.
        /// pop.Disconnect();
        ///
        /// foreach(Attachment attach in message.Attachments) attach.StoreToFile("C:\\mails\\attachments\\"+attach.Filename); //Store message attachments.
        /// 
        /// JScript.NET
        /// 
        ...
        /// pop.Connect("mail.myhost.com","jdoe1234","tanstaaf");
        /// 
        /// var message:Message = pop.RetrieveMessageObject(1,false);//Retrieve message.
        /// pop.Disconnect();
        /// 
        /// for(var i:int = 0;i&lt;message.Attachments.Count;i++) message.Attachments[i].StoreToFile("C:\\mails\\attachments\\"+message.Attachments[i].Filename);//Store message attachments.
        /// </code>
        /// </example>
        ...
        /// pop.Disconnect();
        /// 
        /// foreach(EmbeddedObject obj in message.EmbeddedObjects) obj.StoreToFile("C:\\mails\\objects\\"+obj.Filename);//Store message's embedded objects.
        /// 
        /// JScript.NET
        /// 
        /// var pop:Pop3Client = new Pop3Client();
        ...
        /// pop.Disconnect();
        /// 
        /// for(var i:int = 0;i&lt;message.EmbeddedObjects.Count;i++) message.EmbeddedObjects[i].StoreToFile("C:\\mails\\objects\\"+message.EmbeddedObjects[i].Filename);//Store message's embedded objects.
        /// </code>
        /// </example>
        ...
        /// pop.Disconnect();
        /// 
        /// this.Response.Write("Message body : "+message.BodyText.Text);//Show the message's text body 
        /// 
        /// JScript.NET
        /// 
        /// var pop:Pop3Client = new Pop3Client();
        ...
        /// pop.Disconnect();
        /// 
        /// this.Response.Write("Message body : "+message.BodyText.Text);//Show message's text body.
        /// </code>
        /// </example>
        ...
        /// pop.Disconnect();
        /// 
        /// this.Response.Write("Message body : "+message.BodyHtml.Text);//Show the message's html body 
        /// 
        /// JScript.NET
        /// 
        /// var pop:Pop3Client = new Pop3Client();
        ...
        /// pop.Disconnect();
        /// 
        /// this.Response.Write("Message body : "+message.BodyHtml.Text);//Show message's html body.
        /// </code>
        /// </example>
        ...
        public int Size
        {
            get
            {
                ...
                {
                    _size = this.OriginalData.Length;
        ...
        /// Begins the append.
        /// </summary>
        /// <param name="imapMailbox">The imap mailbox.</param>
