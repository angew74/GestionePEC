...
namespace Com.Delta.PrintManager.Engine
{
	...
	public sealed class PictureBox : ICustomPaint
	{
		...
		[Editor(typeof(Com.Delta.PrintManager.Engine.Editors.ImageFileEditor), typeof(UITypeEditor)),Category("Picture"), Description("Image file location relative to .xml file. For new documents defaults to working directory of Designer.")]
		...
		/// </summary>
		/// <returns><see cref="Com.Delta.PrintManager.Engine.PictureBox">Com.Delta.PrintManager.Engine.PictureBox</see></returns>
