...
using System;
using System.IO;
using Com.Delta.PrintManager.Engine.ZipLib.Checksums;
using Com.Delta.PrintManager.Engine.ZipLib.Zip.Compression;

namespace Com.Delta.PrintManager.Engine.ZipLib.Zip.Compression.Streams 
{
	...
	internal class DeflaterOutputStream : Stream
	{
		...
		/// </param>
		public DeflaterOutputStream(Stream baseOutputStream) : this(baseOutputStream, new Deflater(), 1024)
		{
		}
