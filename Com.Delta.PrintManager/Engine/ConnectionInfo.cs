...
namespace Com.Delta.PrintManager.Engine
{
	...
	public sealed class ConnectionInfo
	{
		...
		/// </summary>
		[Category("General"), Description("Connection string used to access database."), Editor(typeof(Com.Delta.PrintManager.Engine.Editors.PlainTextEditor), typeof(UITypeEditor))]
