...
namespace Com.Delta.PrintManager.Engine
{
	...
	internal class HtmlSerializer
	{
		...
		private void ProcessElement(StringWriter writer, Com.Delta.PrintManager.Engine.ICustomPaint element, int order, int pageOffset, bool hardcodeLink)
		{
			if (element.Anchored)
			{
		...
		private void Process(StringWriter writer, Com.Delta.PrintManager.Engine.ICustomPaint element, int order, int pageOffset, bool hardcodeLink)
		{
		...
		private void ProcessTextField(StringWriter writer, Com.Delta.PrintManager.Engine.TextField textField, int order, int pageOffset)
		{
			bool justify = false;
			string style = "";
			string cellStyle = "";
		...
		private void ProcessRichTextField(StringWriter writer, Com.Delta.PrintManager.Engine.RichTextField richTextField, int order, int pageOffset)
		{
			bool justify = false;
			string style = "";
			string cellStyle = "";
		...
		private void ProcessStyledTable(StringWriter writer, Com.Delta.PrintManager.Engine.StyledTable table, int order, int pageOffset)
		{
			string style = "";
		...
		private void ProcessPictureBox(StringWriter writer, Com.Delta.PrintManager.Engine.PictureBox pictureBox, int order, int pageOffset, bool hardcodeLink)
		{
			string style = "";
		...
		private void ProcessMap(StringWriter writer, Com.Delta.PrintManager.Engine.Map element, int order, int pageOffset, bool hardcodeLink)
		{
			string style = "";
		...
		private void ProcessChartBox(StringWriter writer, Com.Delta.PrintManager.Engine.ChartBox element, int order, int pageOffset, bool hardcodeLink)
		{
			string style = "";
		...
		private void ProcessScatter(StringWriter writer, Com.Delta.PrintManager.Engine.Scatter element, int order, int pageOffset, bool hardcodeLink)
		{
			string style = "";
		...
		private void ProcessTimeline(StringWriter writer, Com.Delta.PrintManager.Engine.Timeline element, int order, int pageOffset, bool hardcodeLink)
		{
			string style = "";
		...
		private void ProcessBarcode(StringWriter writer, Com.Delta.PrintManager.Engine.Barcode element, int order, int pageOffset, bool hardcodeLink)
		{
			string style = "";
		...
		private void ProcessUserPaint(StringWriter writer, Com.Delta.PrintManager.Engine.UserPaint element, int order, int pageOffset, bool hardcodeLink)
		{
			string style = "";
		...
		private void ProcessBox(StringWriter writer, Com.Delta.PrintManager.Engine.Box element, int order, int pageOffset, bool hardcodeLink)
		{
			string style = "";
		...
		private void ProcessLine(StringWriter writer, Com.Delta.PrintManager.Engine.Line element, int order, int pageOffset)
		{
			string style = "";
		...
		private string FormatVerticalAlignment(Com.Delta.PrintManager.Engine.TextField.TextVerticalAlignmentType alignment)
		{
			if (alignment==Com.Delta.PrintManager.Engine.TextField.TextVerticalAlignmentType.Bottom)
				return "valign=bottom";
			else if (alignment==Com.Delta.PrintManager.Engine.TextField.TextVerticalAlignmentType.Middle)
		...
		private string GetColumnContentAlignment(Com.Delta.PrintManager.Engine.StyledTableColumn.AlignmentType alignment)
		{
			switch (alignment)
			{
