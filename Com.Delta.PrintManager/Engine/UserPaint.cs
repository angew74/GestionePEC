...
{
	/// <summary>
	/// Inheritable class that provides empty implementation of Com.Delta.PrintManager.Engine.ICustomPaint. This class is used to create user-defined report widgets.
	/// </summary>
