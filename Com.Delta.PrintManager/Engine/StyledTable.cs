...
namespace Com.Delta.PrintManager.Engine
{
	...
	public sealed class StyledTable : ICustomPaint
	{
		...
		/// </remarks>
		[Editor(typeof(Com.Delta.PrintManager.Engine.Editors.ConditionEditor), typeof(UITypeEditor)), Category("Data"), Description("Filter expression to apply when displaying table. Filtering is not applied for tables holding static data.")]
		...
		/// <summary>
		/// Collection of <see cref="Com.Delta.PrintManager.Engine.StyledTableColumn">Com.Delta.PrintManager.Engine.StyledTableColumn</see> columns contained in this StyledTable element.
		/// </summary>
		...
		/// </summary>
		[Category("Data")]
		[Editor(typeof(Com.Delta.PrintManager.Engine.Editors.StaticTableEditor), typeof(UITypeEditor)), Description("Static table data.")]
		...
		/// <see cref="Com.Delta.PrintManager.Engine.ReportDocument.AddData">Com.Delta.PrintManager.Engine.ReportDocument.AddData(DataTable)</see>
		/// method of the Com.Delta.PrintManager.Engine.ReportDocument class.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// This property is using the same syntax as the Expression property of <see cref="Com.Delta.PrintManager.Engine.ReportDocument.AddData">System.Data.DataColumn</see> property.
		/// </remarks>
		[Editor(typeof(Com.Delta.PrintManager.Engine.Editors.ConditionEditor), typeof(UITypeEditor)), Category("Data"), Description("This property set the query to be used to determine rows that will be shown with alternative color (AlterDataColor).")]	
