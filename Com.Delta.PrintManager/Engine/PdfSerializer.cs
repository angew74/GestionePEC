...
using Com.Delta.PrintManager.Engine.Pdf;
...
namespace Com.Delta.PrintManager.Engine
{
	...
	internal class PdfSerializer
	{
		...
		private void ProcessElement(PdfPage page, Com.Delta.PrintManager.Engine.ICustomPaint element)
		{
			if (element.Anchored)
			{
		...
		private void Process(PdfPage page, Com.Delta.PrintManager.Engine.ICustomPaint element)
		{
			...
			else if (element is Com.Delta.PrintManager.Engine.Line)
				ProcessLine(page, (Com.Delta.PrintManager.Engine.Line)element);
			else if (element is Com.Delta.PrintManager.Engine.Elipse)
				ProcessElipse(page, (Com.Delta.PrintManager.Engine.Elipse)element);
			else if (element is Com.Delta.PrintManager.Engine.Box)
				ProcessBox(page, (Com.Delta.PrintManager.Engine.Box)element);
			else if (element is Com.Delta.PrintManager.Engine.Barcode)
				ProcessBarcode(page, (Com.Delta.PrintManager.Engine.Barcode)element);
			else if (element is Com.Delta.PrintManager.Engine.Map)
				ProcessMap(page, (Com.Delta.PrintManager.Engine.Map)element);
			else if (element is Com.Delta.PrintManager.Engine.Scatter)
				ProcessScatter(page, (Com.Delta.PrintManager.Engine.Scatter)element);
			else if (element is Com.Delta.PrintManager.Engine.UserPaint)
				ProcessUserPaint(page, (Com.Delta.PrintManager.Engine.UserPaint)element);
			else if (element is Com.Delta.PrintManager.Engine.RichTextField)
				ProcessRichTextField(page, (Com.Delta.PrintManager.Engine.RichTextField)element);
		}

		private void ProcessTextField(PdfPage page, Com.Delta.PrintManager.Engine.TextField textField)
		{
			try
			{
		...
		private void ProcessPicture(PdfPage page, Com.Delta.PrintManager.Engine.PictureBox picture)
		{
			try
			{
		...
		private void ProcessChartBox(PdfPage page, Com.Delta.PrintManager.Engine.ChartBox chart)
		{
			try
			{
		...
		private void ProcessScatter(PdfPage page, Com.Delta.PrintManager.Engine.Scatter chart)
		{
			try
			{
				if (chart.BackgroundColor != Color.Transparent && chart.MapAreaColor != Color.Transparent)
		...
		private void ProcessUserPaint(PdfPage page, Com.Delta.PrintManager.Engine.UserPaint userPaint)
		{
			try
			{
		...
		private void ProcessRichTextField(PdfPage page, Com.Delta.PrintManager.Engine.RichTextField richTextField)
		{
			try
			{
		...
		private void ProcessTimeline(PdfPage page, Com.Delta.PrintManager.Engine.Timeline timeline)
		{
			try
			{
		...
		private void ProcessLine(PdfPage page, Com.Delta.PrintManager.Engine.Line line)
		{
			try
			{
		...
		private void ProcessElipse(PdfPage page, Com.Delta.PrintManager.Engine.Elipse elipse)
		{
			try
			{
		...
		private void ProcessBox(PdfPage page, Com.Delta.PrintManager.Engine.Box box)
		{
			try
			{
		...
		private void ProcessBarcode(PdfPage page, Com.Delta.PrintManager.Engine.Barcode barcode)
		{
			try
			{
		...
		private void ProcessMap(PdfPage page, Com.Delta.PrintManager.Engine.Map map)
		{
			try
			{
		...
		private void ProcessStyledTable(PdfPage page, Com.Delta.PrintManager.Engine.StyledTable table)
		{
				...
				if (data.Rows.Count==0)
				{
					if (table.DrawEmptyRows)
					{
						...
						for (int i=0;i<table.Columns.Length;i++)
						{
							if (table.Columns[i].Width>0)
							{
								Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment columnAlignment = GetColumnContentAlignment(table.Columns[i].Alignment);
		...
		private Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment GetColumnContentAlignment(Com.Delta.PrintManager.Engine.StyledTableColumn.AlignmentType alignment)
		{
			switch (alignment)
			{
				case StyledTableColumn.AlignmentType.Left : return Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment.Left;
				case StyledTableColumn.AlignmentType.Center : return Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment.Center;
				case StyledTableColumn.AlignmentType.Right : return Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment.Right;
				default : return Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment.Left;
			}
		}

		private Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment GetTextHorizontalAlignment(TextField.TextAlignmentType horAlignment)
		{
			if (horAlignment == TextField.TextAlignmentType.Right)
			{
				return Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment.Right;
			}
			else if (horAlignment == TextField.TextAlignmentType.Center)
			{
				return Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment.Center;
			}
			else if (horAlignment == TextField.TextAlignmentType.Justified)
			{
				return Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment.Justified;
			}
			else
			{
				return Com.Delta.PrintManager.Engine.Pdf.HorizontalAlignment.Left;
			}
		}

		private Com.Delta.PrintManager.Engine.Pdf.VerticalAlignment GetTextVerticalAlignment(TextField.TextVerticalAlignmentType verAlignment)
		{
			if (verAlignment == TextField.TextVerticalAlignmentType.Bottom)
			{
				return Com.Delta.PrintManager.Engine.Pdf.VerticalAlignment.Bottom;
			}
			else if (verAlignment == TextField.TextVerticalAlignmentType.Middle)
			{
				return Com.Delta.PrintManager.Engine.Pdf.VerticalAlignment.Middle;
			}
			else
			{
				return Com.Delta.PrintManager.Engine.Pdf.VerticalAlignment.Top;
			}
		}
