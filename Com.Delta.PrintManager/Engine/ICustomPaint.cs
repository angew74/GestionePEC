...
namespace Com.Delta.PrintManager.Engine
{
	...
	public abstract class ICustomPaint : ICloneable
	{
		...
		/// <summary>
		/// The <see cref="Com.Delta.PrintManager.Engine.ReportDocument">Com.Delta.PrintManager.Engine.PrintDocument</see> object
		/// </summary>
		...
		/// <summary>
		/// Gets the parent <see cref="Com.Delta.PrintManager.Engine.Section">Section</see> object that this report element belongs to.
		/// </summary>
		[Browsable(false)]
