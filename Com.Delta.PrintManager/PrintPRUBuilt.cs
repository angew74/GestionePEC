...
namespace Com.Delta.PrintManager.Services
{
    public class PrintPRUBuilt : Print
    {
        ...
        /// </summary>
        public PrintPRUBuilt(String pru, String tpuUrl, HttpResponse response)
        {
            this.pru = pru;
            this.url = tpuUrl;
        ...
        /// </summary>
        public PrintPRUBuilt(String pru, String handlerUrl, String applicazione, String stampa, HttpResponse response)
        {
            this.pru = pru;
            this.url = handlerUrl + "?applicazione=" + applicazione + "&stampa=" + stampa;
            this.response = response;
        }
        ...
        /// e il TPU scaricato dal un url specifico 
        /// </summary>
        public PrintPRUBuilt(String tpuUrl, Hashtable parameters, HttpResponse response)
        {
        ...
        /// e il TPU scaricato dal un url specifico 
        /// </summary>
        public PrintPRUBuilt(Hashtable parameters, List<DataTable> tableCollection, String tpuUrl, HttpResponse response)
        {
            this.parameters = parameters;
        ...
        /// con chiavi di ricerca il nome della stampa e dell'applicazione
        /// </summary>
        public PrintPRUBuilt(Hashtable parameters, String handlerUrl, String applicazione, String stampa, HttpResponse response)
        {
            this.parameters = parameters;
            this.url = handlerUrl + "?applicazione=" + applicazione + "&stampa=" + stampa;
            this.response = response;
        ...
        /// mediante l'oggetto "System.Collections.Hashtable" per argomento,
        /// le tabelle passate medainte l'oggetto "System.Collections.Generic.List",
        /// le tabelle passate medainte l'oggetto "System.Collections.Generic.List" per argomento
        /// e il TPU scaricato dall'Handler specifico 
        /// con chiavi di ricerca il nome della stampa e dell'applicazione
        /// </summary>
        public PrintPRUBuilt(Hashtable parameters, List<DataTable> tableCollection, String handlerUrl, String applicazione, String stampa, HttpResponse response)
        {
            this.parameters = parameters;
            this.tableCollection = tableCollection;
            this.url = handlerUrl + "?applicazione=" + applicazione + "&stampa=" + stampa;
        ...
        public override void Invoke()
        {
            ...
            this.response.Clear();
            this.response.ContentType = "UnisysPDPrinterData"; //mime-type
