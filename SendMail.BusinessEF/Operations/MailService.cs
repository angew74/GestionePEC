...
{
    public sealed class MailService : BaseSingletonService<MailService>, SendMail.BusinessEF.Contracts.IMailService
    {
        ...
        {
            using (MailSQLDb dao = this.getDaoContext().DaoImpl.MailDao)
            {
