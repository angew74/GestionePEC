...
{
    public class ComunicazioniService : BaseSingletonService<ComunicazioniService>, SendMail.BusinessEF.Contracts.IComunicazioniService
    {
        ...
        {
            using (ComAllegatoSQLDb dao = new ComAllegatoSQLDb())
            {
