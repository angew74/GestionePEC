...
namespace Com.Delta.Print.Engine
{
	...
	public sealed class StyledTableColumn : ICloneable
	{
		...
		[Editor(typeof(Com.Delta.Print.Engine.Editors.FormatMaskEditor), typeof(UITypeEditor))]
		...
		/// </summary>
		/// <returns><see cref="Com.Delta.Print.Engine.StyledTableColumn">daReport.StyledTableColumn</see></returns>
		public object Clone()
		{
