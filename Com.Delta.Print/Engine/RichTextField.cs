...
using Com.Delta.Print.Engine.Parse.Html;
...
namespace Com.Delta.Print.Engine
{
	...
	public sealed class RichTextField : ICustomPaint
	{
		...
		{
            // Raffaele Russo - 12/12/2011 - Start
            Rectangle bounds = this.Section.Document.DesignMode ? theRegion : new Rectangle(Bounds.X - rBounds.X, Bounds.Y - rBounds.Y, Bounds.Width, Bounds.Height);
		...
		/// </summary>
		[Category("Data")]
		[Editor(typeof(Com.Delta.Print.Engine.Editors.PlainTextEditor), typeof(UITypeEditor)), Description("Content of the RichTextField.")]
		public string Text
		{
			get 
			{
