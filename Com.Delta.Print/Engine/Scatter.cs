...
namespace Com.Delta.Print.Engine
{
	...
	public sealed class Scatter : ICustomPaint
	{
		...
		/// </summary>
		[Category("Title"), Editor(typeof(Com.Delta.Print.Engine.Editors.PlainTextEditor), typeof(UITypeEditor)), Description("The Title of the chart."), DefaultValue("Scatter Diagram Title")]
		public string Title
		{
			get {return mTitle;}
			set {mTitle = value;}
