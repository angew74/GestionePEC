...
namespace Com.Delta.Print.Engine
{
	...
	public class Paper
	{
		...
		/// </summary>
		/// <param name="paperType">PaperType: <see cref="Com.Delta.Print.Engine.Paper.Type">Type</see> of paper.</param>
		...
		/// <returns>Returns <see cref="Com.Delta.Print.Engine.Paper.Type">Type</see> of paper</returns>
