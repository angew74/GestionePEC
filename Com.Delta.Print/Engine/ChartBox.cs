...
namespace Com.Delta.Print.Engine
{
	...
	public sealed class ChartBox : ICustomPaint 
	{
		...
		/// </summary>
		[Category("Title"), Editor(typeof(Com.Delta.Print.Engine.Editors.PlainTextEditor), typeof(UITypeEditor)), Description("The Title of the chart."), DefaultValue("Chart Title")]
		public string Title
		{
			get {return mTitle;}
			set {mTitle = value;}
		...
		/// </summary>
		[Editor(typeof(Com.Delta.Print.Engine.Editors.ChartDataEditor), typeof(UITypeEditor)), Category("Data"), Description("Chart data.")]		
