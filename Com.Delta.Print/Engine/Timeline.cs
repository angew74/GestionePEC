...
namespace Com.Delta.Print.Engine
{
	...
	public sealed class Timeline : ICustomPaint
	{
		...
		/// </summary>
		[Category("Data"),Editor(typeof(Com.Delta.Print.Engine.Editors.DateEditor), typeof(UITypeEditor)), Description("Timeline start date. Used if Timeline.UseDates is set to true."), DefaultValue(typeof(System.DateTime),"1/1/2006")]
		...
		/// </summary>
		[Category("Data"),Editor(typeof(Com.Delta.Print.Engine.Editors.DateEditor), typeof(UITypeEditor)), Description("Timeline end date. Used if Timeline.UseDates is set to true."), DefaultValue(typeof(System.DateTime),"12/31/2006")]
		...
		/// </summary>
		/// <returns><see cref="Com.Delta.Print.Engine.Timeline">Com.Delta.Print.Engine.Timeline</see></returns>
	...
	public class TimelinePoint : ICloneable
	{
		...
		/// </summary>
		[Category("Display"),Editor(typeof(Com.Delta.Print.Engine.Editors.PlainTextEditor), typeof(UITypeEditor)), Description("Gets or sets timepoint label text."), DefaultValue("Timepoint Description")]
		public string Text
		{
			get {return text;}
			set {text = value;}
		...
		/// </summary>
		[Category("Data"), Editor(typeof(Com.Delta.Print.Engine.Editors.DateEditor), typeof(UITypeEditor)), Description("Gets or sets timepoint date. This value is used if Timeline.UseDates is set to true.")]
	...
	public class TimelinePeriod : ICloneable
	{
		...
		/// </summary>
		[Category("Data"), Editor(typeof(Com.Delta.Print.Engine.Editors.DateEditor), typeof(UITypeEditor)), Description("Gets or sets period start date. This value is used if Timeline.UseDates is set to true."), DefaultValue(typeof(System.DateTime),"4/1/2006")]
		public DateTime StartDate
		{
			get {return startDate;}
			set {startDate = value;}
		...
		/// </summary>
		[Category("Data"), Editor(typeof(Com.Delta.Print.Engine.Editors.DateEditor), typeof(UITypeEditor)), Description("Gets or sets period end date. This value is used if Timeline.UseDates is set to true."), DefaultValue(typeof(System.DateTime),"8/1/2006")]
		public DateTime EndDate
		{
			get {return endDate;}
			set {endDate = value;}
