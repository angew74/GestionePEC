...
namespace Com.Delta.Print.Engine 
{
	...
	/// </summary>
	internal class PieChart3D : IDisposable 
	{
	...
	/// </summary>
	internal class Quadrilateral : IDisposable 
	{
