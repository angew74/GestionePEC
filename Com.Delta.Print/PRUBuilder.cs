...
namespace Com.Delta.Print
{
    public class PRUBuilder
    {
        ...
        /// <summary>
        /// Utilizzare se si vuole associare un nome specifico al file PDF
        /// </summary>
        public string NomePDF
        {
            get { return this.nomePDF; }
        ...
        /// crea l'oggetto di stampa a partire dai parametri passati 
        /// mediante l'oggetto "Hashtable" per argomento,
        /// le tabelle passate mediante l'oggetto "List&lt;DataTable&gt;"
        /// e il TPU scaricato dal un url specifico 
        /// </summary>
        ...
        // Ciro Cardone 31/07/2014 - Start
        // L'unica riga commentata fa parte del codice originale
        // aggiunta del parametro versione che indica la versione utilizzata del TPU

        public void ConfigureRemoteTpuRepository(String tpuHandlerServerUrl, String codApp, String codStampa, String versione)
        {

            int lio = tpuHandlerServerUrl.LastIndexOf('/');

            this.url = tpuHandlerServerUrl.Insert(lio + 1, String.Concat(codApp, "/", codStampa, "/" , versione, "/" ));
        ...
        {
            XmlDocument dom = new XmlDocument();
            dom.LoadXml("<?xml version=\"1.0\" encoding=\"UTF-8\"?><params><tpu></tpu><pdf>0</pdf><nomePDF></nomePDF>" +
                        "<html>0</html><dialog>0</dialog><preview>0</preview><zoomPreview></zoomPreview><copie>1</copie></params>");
            ...
            nl = dom.GetElementsByTagName("nomePDF");
            if (nl.Count != 0)
            {
                XmlElement el = nl.Item(0) as XmlElement;
                ...
                if (el.HasChildNodes)
                {
                    el.FirstChild.Value = this.NomePDF;
                }
                else
                {
                    XmlText testo = dom.CreateTextNode(this.NomePDF);
                    el.AppendChild(testo);
                }
            }
        ...
        private void GetPrintValuesFromXML()
        {
            ...
            System.Xml.XmlNode xnodeNomePDF = XMLData.SelectSingleNode("params/nomePDF");
            if (xnodeNomePDF != null)
            {
                this.NomePDF = xnodeNomePDF.InnerText;
            }
