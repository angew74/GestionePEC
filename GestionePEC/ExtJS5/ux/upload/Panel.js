...
Ext.define('Ext.ux.upload.Panel', {
    ...
    config: {
        ...
        textBrowse: 'Scegli',
        textAbort: 'Annulla',
        textRemoveSelected: 'Rimuovi selezionati',
        textRemoveAll: 'Rimuovi tutti',
        ...
        selectionMessageText: 'Selezionati {0} file(s), {1}',
        uploadMessageText: 'Caricamento progressione {0}% ({1} of {2} souborů)',
