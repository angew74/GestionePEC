<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RicercaMail.ascx.cs" Inherits="GestionePEC.Controls.RicercaMail" %>
    ...
    <asp:Panel runat="server" ID="pnlCasella" Style="height: 190px; font-size: smaller" CssClass="control-tab-gray">
        <table class="NewTableSmall">
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="UpdMail" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:Label runat="server" ID="tbMail" Text="Mittente" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
                <td>
                    <asp:TextBox ID="tbMittente" runat="server" SkinID="tbLong"></asp:TextBox>
                </td>
                <td>
                ...
                <td>
                    <asp:TextBox ID="tbOggetto" runat="server" SkinID="tbLong"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdStatus" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlStatus" runat="server" SkinID="ddlMiddle">
                                <asp:ListItem Value="" Text="Selezionare uno stato" />
                                <asp:ListItem Text="Inserita" Value="20" />
                                <asp:ListItem Text="Reinviata" Value="22" />
                                <asp:ListItem Text="Inviata" Value="23" />
                                <asp:ListItem Text="Errore" Value="24" />
                                <asp:ListItem Text="Cancellata" Value="25" />
                                <asp:ListItem Text="Accettazione" Value="26" />
                                <asp:ListItem Text="Non Accettazione" Value="27" />
                                <asp:ListItem Text="Avvenuta Consegna" Value="28" />
                                <asp:ListItem Text="Errore Consegna" Value="29" />
                                <asp:ListItem Text="Archiviata" Value="99" />
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdMarcatori" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlMarcatori" runat="server" SkinID="ddlMiddle">
                                <asp:ListItem Value="" Text="Selezionare un marcatore" />
                                <asp:ListItem Value="1" Text="Un pallino" />
                                <asp:ListItem Value="2" Text="Due pallini" />
                                <asp:ListItem Value="3" Text="Tre pallini" />
                                <asp:ListItem Value="4" Text="Quattro pallini" />
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdTitolo" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlTitolo" runat="server" SkinID="ddlMiddle" OnSelectedIndexChanged="OnChangeIndex_ddlTitolo"
                                AutoPostBack="true">
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdSottotitolo" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlSottotitolo" runat="server" SkinID="ddlMiddle">
            ...
            <tr>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdInbox" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlInboxStato" Enabled="false" runat="server" SkinID="ddlMiddle">
                                <asp:ListItem Text="Selezionare un valore" Value=""></asp:ListItem>
                                <asp:ListItem Text="Letta" Value="1"></asp:ListItem>
                                <asp:ListItem Text="Non Letta" Value="0"></asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            ...
            <asp:Panel runat="server" CssClass="body-panel" ID="PanelGrid">
                <asp:GridView ID="gridBox" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Data" Visible="true" HeaderStyle-Wrap="false"
                            ItemStyle-Width="20px" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label ID="lblDataInvio" runat="server" Text='<%#  Eval("Date").ToString() %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Folder" HeaderStyle-Wrap="false" ItemStyle-Width="15px"
                            ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label ID="lblFolder" runat="server" Text='<%#  Eval("NomeFolder").ToString() %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Tipo" HeaderStyle-Wrap="false" ItemStyle-Width="15px" Visible="false"
...
'Ext.tab.Panel'
    ...
    Ext.onReady(function () {
        ...
        function RIAactiveTabChanged(tab, tabPanel) {
            ...
            */
            ...
            switch (tabPanel.title) {
                case 'Casella Mail':
                    RIAValidationGroup = 'vgTabCodiceIndiv';
                    index = 0;
                    break;
            }
        ...
        var RIAValidationGroup = 'vgTabCodiceIndiv';
