<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Mail.Master" Theme="Delta" AutoEventWireup="true" CodeBehind="MailMove.aspx.cs" Inherits="GestionePEC.pages.MailClient.MailMove" %>
<%@ Register Src="~/controls/MailMoveResearch.ascx" TagName="MailMove" TagPrefix="uc2" %>
 ...
 <div id="mainDivNascita" class="content-panel-borderless">
        ...
        <div id="container" class="body-panel">
         <asp:UpdatePanel runat="server" ID="pnlLogin" UpdateMode="Conditional" ChildrenAsTriggers="false">                
                <ContentTemplate>   
                <uc2:MailMove ID="MailMoveResearch" runat="server" OnSelectMail="MailResearch_Mail" OnHideMail="MailResearch_Hide" />  
                </ContentTemplate>
            </asp:UpdatePanel>             
